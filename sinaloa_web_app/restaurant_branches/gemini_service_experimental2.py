...
def query_gemini(prompt, model="gemini-1.5-flash"):
    ...
    Tu tarea es interpretar preguntas y generar el código Django ORM necesario para obtener la información solicitada asignando lo que obtenga a una variable llamada result mandando el resultado como un diccionario donde se ignoren los campos que hagan referencias a imagenes.
    Ejemplos:
